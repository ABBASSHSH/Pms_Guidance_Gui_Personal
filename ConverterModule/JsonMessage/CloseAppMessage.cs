...
// File   : CloseAppMessage.cs
// Description: Represents the inbound JSON payload for the CloseApp action
...
{
    /// <summary>
    /// Represents the inbound JSON payload for the <c>CloseApp</c>
