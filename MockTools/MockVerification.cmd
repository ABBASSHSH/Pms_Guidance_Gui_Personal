...
set "WAIT_SECONDS=%~1"
if "%WAIT_SECONDS%"=="" set "WAIT_SECONDS=5"
...
echo [MockVerification] Starting verification mock. Wait=%WAIT_SECONDS%s Result=%RESULT_NORMALIZED%
...
echo [MockVerification] Unknown result value '%RESULT_NORMALIZED%'. Defaulting to failure.
exit /b 0
